                ...
                >
                    ...
                    <div class="text-xs">
                        <p>
                            ...
                            <span class="font-semibold text-white">{{ totalDepositValue.toFixed(2) || 0.00}}</span>
                        </p>
                        <p>
                ...
                <div v-if="refsList.length > 0" class="w-full h-auto overflow-y-auto flex flex-col gap-3 p-4">
                    <div v-for="(user, index) in refsList" :key="index" class="flex rounded-lg p-3 px-4 gap-10 md:gap-16 justify-start items-center color-box text-xs">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <div>Depósito: {{ user.totalDepositado.toFixed(2) }}</div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    computed: {
        ...
        firstSignature(){
            return atob('RGVzZW52b2x2aWRvIHBvciBEYWFucm94')
        },
        secondSignature(){
            return atob('d3d3LmRhYW5yb3guY29t')
        }
