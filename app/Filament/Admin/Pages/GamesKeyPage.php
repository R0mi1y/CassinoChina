...
class GamesKeyPage extends Page implements HasForms
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                                  Section::make('Api Pg 12 Jogos')
                ->description('Ajustes de credenciais para Api Pg 12 Jogos')
                ->schema([
                ...
                ->columns(2),
                Section::make('Api Pragmatic 40 Jogos')
                ->description('Ajustes de credenciais para Api Pragmatic 40 Jogos')
                ->schema([
                ...
                Section::make('GitSlotPark PGSoft')
                    ->description('Ajustes de credenciais para a GitSlotPark PGSoft')
                    ->schema([
                        TextInput::make('gitslotpark_agent_code')
                            ->label('Agent Code')
                            ->placeholder('Digite aqui o Agent Code')
                            ->maxLength(191),
                        TextInput::make('gitslotpark_agent_token')
                            ->label('Agent Token')
                            ->placeholder('Digite aqui o Agent Token')
                            ->maxLength(191),
                        TextInput::make('gitslotpark_agent_secret')
                            ->label('Agent Secret')
                            ->placeholder('Digite aqui a Agente Secret')
                            ->maxLength(191),
                        TextInput::make('gitslotpark_api_endpoint')
                            ->label('Api Endpoint')
